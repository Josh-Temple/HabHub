...
describe('isHabitDue', () => {
  ...
  it('flex week monday start respected', () => yes({ ...base, frequency: 'flexible', schedule: { interval: 'week', targetIntervalCount: 1 } }, [{ user_id: 'u', habit_id: 'h', date_key: '2025-01-26', count: 1, completed: true }]));
